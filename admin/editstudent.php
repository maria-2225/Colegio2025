		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <select name="class" class="form-control" id="class" required="" value="">
		    	...
		    	<option value="Primero" <?= $row['class']=='Primero'? 'selected':'' ?>>1ro-A</option>
		    	<option value="Segundo" <?= $row['class']=='Segundo'? 'selected':'' ?>>1ro-B</option>
		    	<option value="Tercero" <?= $row['class']=='Tercero'? 'selected':'' ?>>1ro-C</option>
		    	<option value="Cuarto" <?= $row['class']=='Cuarto'? 'selected':'' ?>>1ro-D</option>
		    	<option value="Quinto" <?= $row['class']=='Quinto'? 'selected':'' ?>>1ro-E</option>
				<option value="Primero" <?= $row['class']=='Primero'? 'selected':'' ?>>2do-A</option>
		    	<option value="Segundo" <?= $row['class']=='Segundo'? 'selected':'' ?>>2doo-B</option>
		    	<option value="Tercero" <?= $row['class']=='Tercero'? 'selected':'' ?>>2do-C</option>
		    	<option value="Cuarto" <?= $row['class']=='Cuarto'? 'selected':'' ?>>2do-D</option>
		    	<option value="Quinto" <?= $row['class']=='Quinto'? 'selected':'' ?>>2do-E</option>
				<option value="Primero" <?= $row['class']=='Primero'? 'selected':'' ?>>3ro-A</option>
		    	<option value="Segundo" <?= $row['class']=='Segundo'? 'selected':'' ?>>3ro-B</option>
		    	<option value="Tercero" <?= $row['class']=='Tercero'? 'selected':'' ?>>3ro-C</option>
		    	<option value="Cuarto" <?= $row['class']=='Cuarto'? 'selected':'' ?>>3ro-D</option>
		    	<option value="Quinto" <?= $row['class']=='Quinto'? 'selected':'' ?>>4to-A</option>
				<option value="Primero" <?= $row['class']=='Primero'? 'selected':'' ?>>4to-B</option>
		    	<option value="Segundo" <?= $row['class']=='Segundo'? 'selected':'' ?>>4to-C</option>
		    	<option value="Tercero" <?= $row['class']=='Tercero'? 'selected':'' ?>>4to-D</option>
		    	<option value="Cuarto" <?= $row['class']=='Cuarto'? 'selected':'' ?>>5to-A</option>
		    	<option value="Quinto" <?= $row['class']=='Quinto'? 'selected':'' ?>>5to-B</option>
				<option value="Primero" <?= $row['class']=='Primero'? 'selected':'' ?>>5to-C</option>
		    	<option value="Segundo" <?= $row['class']=='Segundo'? 'selected':'' ?>>5to-D</option>
		    	<option value="Tercero" <?= $row['class']=='Tercero'? 'selected':'' ?>>5to-E</option>
		    </select>
	  	</div>
	  	<div class="form-group">
